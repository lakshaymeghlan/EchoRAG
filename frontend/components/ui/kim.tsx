...
const UNIFORMS = {
  colors: [[0,0.07058823529411765,0.09803921568627451],[0,0.37254901960784315,0.45098039215686275],[0.5803921568627451,0.8235294117647058,0.7411764705882353],[0.9137254901960784,0.8470588235294118,0.6509803921568628],[0.9137254901960784,0.8470588235294118,0.6509803921568628],[0.9137254901960784,0.8470588235294118,0.6509803921568628],[0.9137254901960784,0.8470588235294118,0.6509803921568628],[0.9137254901960784,0.8470588235294118,0.6509803921568628]] as [number, number, number][],
  colorCount: 4,
  scale: 1.920,
  intensity: 0.600,
  paramA: 0.330,
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // `render` below is a hoisted function declaration, and TypeScript drops
    // the null-narrowing from the guards above inside hoisted functions (it
    // cannot prove they run after the guard). These aliases carry the narrowed
    // types in; behaviour is unchanged.
